...
# python predict_video.py --model model/activity_gpu.model --label-bin model/lb.pickle --input example_clips/wildfire_movie.mp4 --output output/wildfire_movie_output.avi --size 10
